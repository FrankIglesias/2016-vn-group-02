...
public class PoiMainTest {
	...
	public void init() {
		...
		domicilioColectivo = new Domicilio("Manuel Alvarez Prado", "Bolivia y Av. de Los Constituyentes", "2402-2600",
				"", "", "1419");
		...
		domicilioCGP = new Domicilio("Av. de los Constituyentes", "Jose Pascual Tamborini e Ibera", "5836", "PB", "",
				"1419");
