...
public class EncuentraSegunPalabraClaveTest {
	...
	public void init(){  
		...
		banco = new Banco(geolocalizacionBanco, "Banco Rio", palabrasClaveBanco);
		...
		colectivo = new Colectivo(geolocalizacionColectivo, "Colectivo", palabrasClaveColectivo,"127");
